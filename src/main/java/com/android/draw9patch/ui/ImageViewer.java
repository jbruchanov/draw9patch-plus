...
public class ImageViewer extends JComponent {
    ...
    private void computeHoverRegionTooltip(UpdateRegionInfo vertical, UpdateRegionInfo horizontal) {
        ...
        if (vertical != null && vertical.segment != null) {
            ...
            sb.append(String.format("|%d - %d - %d| px",
                    vertical.segment.first, vertical.segment.second - vertical.segment.first, image.getHeight() - vertical.segment.second));
        }
        ...
        if (horizontal != null && horizontal.segment != null) {
            ...
            sb.append(String.format("|%d - %d - %d| px",
                    horizontal.segment.first, horizontal.segment.second - horizontal.segment.first, image.getWidth() - horizontal.segment.second));
        }

        toolTipText = sb.length() > 0 ? "<html>" + sb.toString() + "</html>" : null;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (mDrawHalfs) {
            ...
            cursor.setColor(new Color(1f, 0f, 1f, .5f));
            ...
            cursor.setStroke(dashed);
            int topImage = helpPanel.getHeight() + (getHeight() - size.height) / 2;
            int bottomImage = helpPanel.getHeight() + (getHeight() + size.height) / 2;
            int diff = bottomImage - topImage;
            int diffHalf = diff >> 1;

            //this is some shit about 1px here..
            cursor.drawLine(0, topImage + diffHalf, getWidth(), topImage + diffHalf);
            cursor.drawLine(getWidth() >> 1, 0, getWidth() >> 1, getHeight());
    ...
    private boolean mDrawHalfs = false;
